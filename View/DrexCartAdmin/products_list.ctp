...
<p><?php echo $this->Js->link('Show Disabled', '/DrexCartAdmin/productsList/showDisabled:true', array('update'=>'#panel_content', 'buffer'=>false)); ?>
&nbsp;&nbsp;&nbsp;&nbsp;
<?php echo $this->Js->link('Show Invisible', '/DrexCartAdmin/productsList/showInvisible:true', array('update'=>'#panel_content', 'buffer'=>false)); ?></p>
